object dmDVC: TdmDVC
  ...
  object cdsSourceA: TClientDataSet
    ...
    object cdsSourceASOURCETYPEID: TWideStringField
  ...
  object cdsIsoValidCaptured: TClientDataSet
    ...
    object cdsIsoValidCapturedVALIDSTATUSID: TWideStringField
    ...
    object cdsIsoValidCapturedDONEBY: TWideStringField
  ...
  object cdsIsoValidValidated: TClientDataSet
    ...
    object cdsIsoValidValidatedVALIDSTATUSID: TWideStringField
      DisplayLabel = 'Status ID'
      FieldName = 'VALIDSTATUSID'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      Required = True
    ...
    object cdsIsoValidValidatedDONEBY: TWideStringField
      DisplayLabel = 'Done By'
      FieldName = 'DONEBY'
      Required = True
    end
  ...
  object dsqRecordIDIsoFor: TDataSource
    DataSet = qRecordIDsIsoFor
    Left = 548
    Top = 40
  end
  ...
  object cdsCountryRecords: TClientDataSet
    ...
    Left = 376
    Top = 284
    object cdsCountryRecordsCOUNTRYABR: TWideStringField
    ...
    object cdsCountryRecordsCOUNTRYHASRECORDS: TWideStringField
  ...
  object cdsCountryCount: TClientDataSet
    ...
    Left = 368
    Top = 332
    object cdsCountryCountCOUNTRYABR: TWideStringField
      DisplayLabel = 'Country ID'
      FieldName = 'COUNTRYABR'
      ReadOnly = True
      Required = True
  ...
  object qSmpLocC: TSQLQuery
    ...
    Left = 180
    Top = 392
    object qSmpLocCSAMPLENO: TWideStringField
      FieldName = 'SAMPLENO'
      Required = True
    end
    object qSmpLocCCONTINENTID: TWideStringField
      FieldName = 'CONTINENTID'
      Required = True
      Size = 3
    end
    object qSmpLocCCOUNTRYABR: TWideStringField
      FieldName = 'COUNTRYABR'
      Required = True
      Size = 3
    end
    object qSmpLocCC: TWideStringField
      FieldName = 'C'
      ProviderFlags = []
      Size = 3
    end
    object qSmpLocCD: TWideStringField
      FieldName = 'D'
      ProviderFlags = []
      Size = 3
    end
  ...
  object cdsSmpLocC: TClientDataSet
    ...
    Left = 236
    Top = 392
    object cdsSmpLocCSAMPLENO: TWideStringField
      FieldName = 'SAMPLENO'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      Required = True
    end
    object cdsSmpLocCCONTINENTID: TWideStringField
      FieldName = 'CONTINENTID'
      Required = True
      Size = 3
    end
    object cdsSmpLocCCOUNTRYABR: TWideStringField
      FieldName = 'COUNTRYABR'
      Required = True
      Size = 3
    end
    object cdsSmpLocCC: TWideStringField
      FieldName = 'C'
      ProviderFlags = []
      Size = 3
    end
    object cdsSmpLocCD: TWideStringField
      FieldName = 'D'
      ProviderFlags = []
      Size = 3
    end
  ...
  object cdsNumContributions: TClientDataSet
    ...
    Left = 80
    Top = 384
    object cdsNumContributionsDONEBY: TWideStringField
      FieldName = 'DONEBY'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      ReadOnly = True
      Required = True
  ...
  object qUnitsDV: TSQLQuery
    ...
    Left = 184
    Top = 456
    object qUnitsDVUNITNAME: TWideStringField
      FieldName = 'UNITNAME'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      Required = True
      Size = 150
    ...
    object qUnitsDVCOUNTRYABR: TWideStringField
      FieldName = 'COUNTRYABR'
      ProviderFlags = []
      Size = 3
    end
  ...
  object cdsUnitsDV: TClientDataSet
    ...
    Left = 236
    Top = 456
    object cdsUnitsDVUNITNAME: TWideStringField
      FieldName = 'UNITNAME'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      Required = True
      Size = 150
    ...
    object cdsUnitsDVCOUNTRYABR: TWideStringField
      FieldName = 'COUNTRYABR'
      ProviderFlags = []
      Size = 3
    end
  ...
  object qParentUnitsDV: TSQLQuery
    ...
    Left = 336
    Top = 456
    object qParentUnitsDVUNITNAME: TWideStringField
      FieldName = 'UNITNAME'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      Required = True
      Size = 150
  ...
  object cdsParentUnitsDV: TClientDataSet
    ...
    Left = 388
    Top = 456
    object cdsParentUnitsDVUNITNAME: TWideStringField
      FieldName = 'UNITNAME'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      Required = True
      Size = 150
  ...
  object cdsUnitHasRecords: TClientDataSet
    ...
    Left = 344
    Top = 540
    object cdsUnitHasRecordsUNITNAME: TWideStringField
      FieldName = 'UNITNAME'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      Required = True
      Size = 150
  ...
  object cdsUnitRecordsYN: TClientDataSet
    ...
    Left = 336
    Top = 636
    object cdsUnitRecordsYNUNITNAME: TWideStringField
      FieldName = 'UNITNAME'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      Required = True
      Size = 150
    end
    object cdsUnitRecordsYNCOUNTRYABR: TWideStringField
      FieldName = 'COUNTRYABR'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      Required = True
      Size = 3
    end
    object cdsUnitRecordsYNUNITHASRECORDS: TWideStringField
  ...
  object cdsUnitCount: TClientDataSet
    ...
    Left = 340
    Top = 676
    object cdsUnitCountUNITNAME: TWideStringField
      FieldName = 'UNITNAME'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      ReadOnly = True
      Required = True
  ...
  object QdmSmp: TSQLQuery
    ...
    object QdmSmpORIGINALNO: TWideStringField
      FieldName = 'ORIGINALNO'
      Required = True
    end
    object QdmSmpLITHCLASSID: TWideStringField
  ...
  object cdsQdmSmp: TClientDataSet
    ...
    object cdsQdmSmpORIGINALNO: TWideStringField
      FieldName = 'ORIGINALNO'
      Required = True
    end
    object cdsQdmSmpLITHCLASSID: TWideStringField
      FieldName = 'LITHCLASSID'
      Required = True
      FixedChar = True
      Size = 1
  ...
  object qDVrecord: TSQLQuery
    ...
    object qDVrecordCOUNTRYABR: TWideStringField
      FieldName = 'COUNTRYABR'
      Required = True
      Size = 3
    end
    ...
    object qDVrecordMATERIALABR: TWideStringField
      FieldName = 'MATERIALABR'
      Required = True
      Size = 5
    end
    object qDVrecordISOTOPESYSTEM: TWideStringField
      FieldName = 'ISOTOPESYSTEM'
      Required = True
      Size = 15
    end
    object qDVrecordAPPROACHABR: TWideStringField
      FieldName = 'APPROACHABR'
      Required = True
      Size = 5
    end
    object qDVrecordTECHABR: TWideStringField
      FieldName = 'TECHABR'
      Required = True
      Size = 5
    end
    object qDVrecordINTERPABR: TWideStringField
      FieldName = 'INTERPABR'
      Required = True
      Size = 5
    end
    ...
    object qDVrecordAGEUNITS: TWideStringField
      FieldName = 'AGEUNITS'
      Required = True
      Size = 2
    end
    object qDVrecordAGERELID: TWideStringField
      FieldName = 'AGERELID'
      Required = True
      FixedChar = True
      Size = 2
    end
    object qDVrecordLITHOLOGY: TWideStringField
      FieldName = 'LITHOLOGY'
      Required = True
      Size = 50
    end
    object qDVrecordMETHODABR: TWideStringField
      FieldName = 'METHODABR'
      Required = True
      FixedChar = True
      Size = 1
    ...
    object qDVrecordREGISTEREDUSER: TWideStringField
  ...
  object cdsRecordIDsLithol: TClientDataSet
    ...
    object cdsRecordIDsLitholLITHOLOGY: TWideStringField
      FieldName = 'LITHOLOGY'
      Required = True
      Size = 50
    end
    ...
    object cdsRecordIDsLitholSAMPLENO: TWideStringField
      FieldName = 'SAMPLENO'
      Required = True
    end
    object cdsRecordIDsLitholSMPLITH: TWideStringField
      FieldName = 'SMPLITH'
      Required = True
      Size = 50
    end
  ...
  object qSmpLithol: TSQLQuery
    ...
    Left = 272
    Top = 208
    object qSmpLitholSAMPLENO: TWideStringField
      FieldName = 'SAMPLENO'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      Required = True
    end
    object qSmpLitholLITHOLOGY: TWideStringField
      FieldName = 'LITHOLOGY'
      Required = True
      Size = 50
    end
  ...
  object cdsSmpLithol: TClientDataSet
    ...
    Left = 332
    Top = 208
    object cdsSmpLitholSAMPLENO: TWideStringField
      FieldName = 'SAMPLENO'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      Required = True
    end
    object cdsSmpLitholLITHOLOGY: TWideStringField
      FieldName = 'LITHOLOGY'
      Required = True
      Size = 50
    end
  ...
  object cdsDepositSamplesMissingLocations: TClientDataSet
    ...
    object cdsDepositSamplesMissingLocationsSAMPLENO: TWideStringField
      FieldName = 'SAMPLENO'
      Required = True
    end
  ...
  object cdsRecordIDsDup: TClientDataSet
    ...
    object cdsRecordIDsDupINTERPABR: TWideStringField
      FieldName = 'INTERPABR'
      ProviderFlags = []
      ReadOnly = True
      Size = 5
    end
    object cdsRecordIDsDupISOTOPESYSTEM: TWideStringField
      FieldName = 'ISOTOPESYSTEM'
      ProviderFlags = []
      ReadOnly = True
      Size = 15
    ...
    object cdsRecordIDsDupMATERIALABR: TWideStringField
      FieldName = 'MATERIALABR'
      ProviderFlags = []
      ReadOnly = True
      Size = 5
    end
    object cdsRecordIDsDupSAMPLENO: TWideStringField
      FieldName = 'SAMPLENO'
      ProviderFlags = []
      ReadOnly = True
    end
  ...
  object cdsDup: TClientDataSet
    ...
    object cdsDupSAMPLENO: TWideStringField
      FieldName = 'SAMPLENO'
      ProviderFlags = []
    end
    object cdsDupFRAC: TWideStringField
      FieldName = 'FRAC'
      ProviderFlags = []
      Size = 15
    end
    ...
    object cdsDupMATERIALABR: TWideStringField
      FieldName = 'MATERIALABR'
      ProviderFlags = []
      Required = True
      Size = 5
    end
    object cdsDupISOSYSTEM: TWideStringField
      FieldName = 'ISOSYSTEM'
      Required = True
      Size = 15
    end
  ...
  object dspGDUs: TDataSetProvider
    DataSet = qGDUs
    Left = 978
    Top = 371
  end
  object cdsGDUs: TClientDataSet
    Aggregates = <>
    Params = <>
    ProviderName = 'dspGDUs'
    Left = 1006
    Top = 371
    object cdsGDUsGDUID: TFMTBCDField
      FieldName = 'GDUID'
      KeyFields = 'GDUID'
      Required = True
      Precision = 20
    ...
    object cdsGDUsGDUNAME: TWideStringField
      FieldName = 'GDUNAME'
      Required = True
      Size = 100
    end
    object cdsGDUsRCNMDLID: TWideStringField
      FieldName = 'RCNMDLID'
      Required = True
      Size = 10
    end
    object cdsGDUsMAXIGNEOUSAGE: TFloatField
      FieldName = 'MAXIGNEOUSAGE'
      Required = True
      DisplayFormat = '###0.000'
    end
    object cdsGDUsMAXMETAMORPHICAGE: TFloatField
      FieldName = 'MAXMETAMORPHICAGE'
      Required = True
      DisplayFormat = '###0.000'
    end
    object cdsGDUsMAXCRUSTALRESAGE: TFloatField
      FieldName = 'MAXCRUSTALRESAGE'
      Required = True
      DisplayFormat = '###0.000'
    end
    object cdsGDUsMAXDETRITALAGE: TFloatField
      FieldName = 'MAXDETRITALAGE'
      Required = True
      DisplayFormat = '###0.000'
    end
    ...
    object cdsGDUsMAXAGEREFS: TWideStringField
  ...
  object dspIsoGDU: TDataSetProvider
    DataSet = qIsoGDU
    Left = 978
    Top = 435
  end
  object cdsIsoGDU: TClientDataSet
    Aggregates = <>
    Params = <>
    ProviderName = 'dspIsoGDU'
    Left = 1006
    Top = 435
    object cdsIsoGDURECORDID: TIntegerField
      FieldName = 'RECORDID'
      KeyFields = 'RECORDID;GDUID;RCNMDLID'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      Required = True
    end
    object cdsIsoGDURCNMDLID: TWideStringField
      FieldName = 'RCNMDLID'
      KeyFields = 'RECORDID;GDUID;RCNMDLID'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      Required = True
    ...
    object cdsIsoGDUGDUID: TFMTBCDField
      FieldName = 'GDUID'
      KeyFields = 'RECORDID;GDUID;RCNMDLID'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      Required = True
  ...
  object dsIsoGDU: TDataSource
    DataSet = cdsIsoGDU
    Left = 1034
    Top = 435
  end
  object qGDUPDF: TSQLQuery
    ObjectView = True
    MaxBlobSize = -1
    Params = <
      item
    ...
    SQL.Strings = (
      'select * '
      'from GDUsPDF'
      'where GDUSPDF.RCNMDLID= :RcnMdlID'
      'and GDUSPDF.GDUID = :GDUID'
      'and GDUSPDF.CurveInterp = :CurveInterp'
      'order by GDUSPDF.CurveOrder,GDUSPDF.PDFOrder'
      ''
      ''
      '')
    SQLConnection = sqlcDateView
  ...
  object dspGDUPDF: TDataSetProvider
    DataSet = qGDUPDF
    Left = 978
    Top = 499
  end
  object cdsGDUPDF: TClientDataSet
    Aggregates = <>
    Params = <>
    ProviderName = 'dspGDUPDF'
    Left = 1006
    Top = 499
    object cdsGDUPDFRCNMDLID: TWideStringField
      FieldName = 'RCNMDLID'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      Required = True
      Size = 10
    ...
    object cdsGDUPDFCURVEORDER: TSmallintField
      FieldName = 'CURVEORDER'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      Required = True
    end
    object cdsGDUPDFPDFORDER: TIntegerField
      FieldName = 'PDFORDER'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      Required = True
    end
    object cdsGDUPDFAGE: TFloatField
      FieldName = 'AGE'
      Required = True
      DisplayFormat = '###0.000'
    end
    object cdsGDUPDFPDFVALUE: TFloatField
      FieldName = 'PDFVALUE'
      Required = True
      DisplayFormat = '###.00000'
    end
    object cdsGDUPDFCURVEINTERP: TWideStringField
      FieldName = 'CURVEINTERP'
      Required = True
      Size = 5
    end
  ...
  object dspGDURecordAges: TDataSetProvider
    DataSet = qGDURecordAges
    Left = 978
    Top = 563
  end
  object cdsGDURecordAges: TClientDataSet
    Aggregates = <>
    Params = <>
    ProviderName = 'dspGDURecordAges'
    Left = 1006
    Top = 563
    object cdsGDURecordAgesRECORDID: TIntegerField
      FieldName = 'RECORDID'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      Required = True
    end
    object cdsGDURecordAgesRCNMDLID: TWideStringField
      FieldName = 'RCNMDLID'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      Required = True
      Size = 10
    end
    object cdsGDURecordAgesGDUID: TFMTBCDField
      FieldName = 'GDUID'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      Required = True
      Precision = 20
    ...
    object cdsGDURecordAgesRAGE: TFloatField
      FieldName = 'RAGE'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
    end
    object cdsGDURecordAgesRAGEPERROR: TFloatField
      FieldName = 'RAGEPERROR'
    end
    object cdsGDURecordAgesRAGEMERROR: TFloatField
      FieldName = 'RAGEMERROR'
    end
    object cdsGDURecordAgesINTERPABR: TWideStringField
      FieldName = 'INTERPABR'
      Required = True
      Size = 5
    end
  end
  object dsGDURecordAges: TDataSource
    DataSet = cdsGDURecordAges
    Left = 1034
    Top = 563
  end
  object qDelete: TSQLQuery
    MaxBlobSize = -1
    Params = <>
    SQLConnection = sqlcDateView
    Left = 920
  ...
  object qUpdate: TSQLQuery
    ...
    SQL.Strings = (
      'UPDATE GDUS'
      'SET GDUS.CountIgneous = :CountRecords,'
      '       GDUS.MaxIgneousAge = :MaxAge,'
      '       GDUS.DateUpdated := :DateUpdated'
      'WHERE GDUS.GDUID = :GDUID'
      'and GDUS.RCNMDLID = :RcnMdlID')
    SQLConnection = sqlcDateView
    Left = 968
    Top = 620
  end
  object qMaxAgeRef: TSQLQuery
    ObjectView = True
    MaxBlobSize = -1
    Params = <
      item
    ...
    SQL.Strings = (
      'select gdus.gduid, gdus.maxigneousage, isogdu.recordid,'
      '  isorgr30.rage,sourcelist.sourceshort'
      'from gdus,isogdu,isorgr30, sourcea, sourcelist'
      'where gdus.gduid=isogdu.gduid'
      'and gdus.rcnmdlid=isogdu.rcnmdlid'
      'and gdus.maxigneousage=isorgr30.rage'
      'and isogdu.recordid=isorgr30.recordid'
      
        'and ((isorgr30.interpabr='#39'CrysI'#39') or (isorgr30.interpabr='#39'CrysV'#39 +
        '))'
      'and isorgr30.recordid=sourcea.recordid'
      'and sourcea.refnum=sourcelist.sourcenum'
      'and sourcea.sourcetypeid=:sourcetypeid'
      'and gdus.gduid = :gduid'
      'and gdus.rcnmdlID = :rcnmdlid')
    SQLConnection = sqlcDateView
    Left = 956
    Top = 683
  end
  object dspMaxAgeRef: TDataSetProvider
    DataSet = qMaxAgeRef
    Left = 986
    Top = 683
  end
  object cdsMaxAgeRef: TClientDataSet
    Aggregates = <>
    Params = <>
    ProviderName = 'dspMaxAgeRef'
    Left = 1014
    Top = 683
    object cdsMaxAgeRefGDUID: TFMTBCDField
      FieldName = 'GDUID'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      Required = True
      Precision = 20
    ...
    object cdsMaxAgeRefMAXIGNEOUSAGE: TFloatField
      FieldName = 'MAXIGNEOUSAGE'
      Required = True
    end
    object cdsMaxAgeRefRECORDID: TIntegerField
      FieldName = 'RECORDID'
      Required = True
    end
    object cdsMaxAgeRefRAGE: TFloatField
      FieldName = 'RAGE'
    end
    object cdsMaxAgeRefSOURCESHORT: TWideStringField
      FieldName = 'SOURCESHORT'
      Required = True
      Size = 100
    end
  end
  object dsMaxAgeRef: TDataSource
    DataSet = cdsMaxAgeRef
    Left = 1042
    Top = 683
  end
  object qGDUSmpdataAges: TSQLQuery
    ObjectView = True
    MaxBlobSize = -1
    Params = <
      item
  ...
  object dspGDUSmpdataAges: TDataSetProvider
    DataSet = qGDUSmpdataAges
    Left = 818
    Top = 683
  end
  object cdsGDUSmpdataAges: TClientDataSet
    Aggregates = <>
    Params = <>
  ...
  object cdsGDULIPages: TClientDataSet
    ...
    object cdsGDULIPagesSAMPLENO: TWideStringField
      FieldName = 'SAMPLENO'
      Required = True
      Size = 80
    end
