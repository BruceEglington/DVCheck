...
uses
  ...
  WideStrings, DbxDevartInterBase, DVC_dmStrat;
...
type
  TdmDVC = class(TDataModule)
    ...
    cdsSourceASOURCETYPEID: TWideStringField;
    ...
    cdsIsoValidCapturedVALIDSTATUSID: TWideStringField;
    cdsIsoValidCapturedDATEDONE: TSQLTimeStampField;
    cdsIsoValidCapturedDONEBY: TWideStringField;
    ...
    cdsIsoValidValidatedVALIDSTATUSID: TWideStringField;
    cdsIsoValidValidatedDATEDONE: TSQLTimeStampField;
    cdsIsoValidValidatedDONEBY: TWideStringField;
    ...
    cdsIsoForWHOFORID: TWideStringField;
    ...
    cdsCountryRecordsCOUNTRYABR: TWideStringField;
    cdsCountryRecordsCOUNTRYHASRECORDS: TWideStringField;
    cdsCountryRecordsNUMRECORDS: TIntegerField;
    cdsCountryCountCOUNTRYABR: TWideStringField;
    qSmpLocC: TSQLQuery;
    dspSmpLocC: TDataSetProvider;
    cdsSmpLocC: TClientDataSet;
    dsSmpLocC: TDataSource;
    cdsSmpLocCSAMPLENO: TWideStringField;
    cdsSmpLocCCONTINENTID: TWideStringField;
    cdsSmpLocCCOUNTRYABR: TWideStringField;
    qSmpLocCSAMPLENO: TWideStringField;
    qSmpLocCCONTINENTID: TWideStringField;
    qSmpLocCCOUNTRYABR: TWideStringField;
    qSmpLocCC: TWideStringField;
    cdsSmpLocCC: TWideStringField;
    qSmpLocCD: TWideStringField;
    cdsSmpLocCD: TWideStringField;
    ...
    cdsNumContributionsDONEBY: TWideStringField;
    qUsers: TSQLQuery;
    ...
    cdsUnitsDVCOUNTRYABR: TWideStringField;
    cdsUnitsDVUNITNAME: TWideStringField;
    cdsUnitsDVGISID: TIntegerField;
    qUnitsDVCOUNTRYABR: TWideStringField;
    qUnitsDVUNITNAME: TWideStringField;
    ...
    qParentUnitsDVUNITNAME: TWideStringField;
    qParentUnitsDVGISID: TIntegerField;
    qParentUnitsDVPARENTID: TIntegerField;
    cdsParentUnitsDVUNITNAME: TWideStringField;
    ...
    cdsUnitHasRecordsUNITNAME: TWideStringField;
    cdsUnitHasRecordsqUnitRecordsYN: TDataSetField;
    cdsUnitRecordsYNUNITNAME: TWideStringField;
    cdsUnitRecordsYNCOUNTRYABR: TWideStringField;
    cdsUnitRecordsYNUNITHASRECORDS: TWideStringField;
    cdsUnitRecordsYNqUnitCount: TDataSetField;
    cdsUnitCountUNITNAME: TWideStringField;
    ...
    qDVrecordCOUNTRYABR: TWideStringField;
    qDVrecordUNITID: TIntegerField;
    qDVrecordMATERIALABR: TWideStringField;
    qDVrecordISOTOPESYSTEM: TWideStringField;
    qDVrecordAPPROACHABR: TWideStringField;
    qDVrecordTECHABR: TWideStringField;
    qDVrecordINTERPABR: TWideStringField;
    ...
    qDVrecordAGEUNITS: TWideStringField;
    qDVrecordAGERELID: TWideStringField;
    qDVrecordLITHOLOGY: TWideStringField;
    qDVrecordMETHODABR: TWideStringField;
    ...
    qDVrecordREGISTEREDUSER: TWideStringField;
    ...
    cdsIsoLabLABORATORYABR: TWideStringField;
    ...
    cdsRecordIDsLitholLITHOLOGY: TWideStringField;
    cdsRecordIDsLitholqSmpLithol: TDataSetField;
    cdsSmpLitholSAMPLENO: TWideStringField;
    cdsSmpLitholLITHOLOGY: TWideStringField;
    qSmpLitholSAMPLENO: TWideStringField;
    qSmpLitholLITHOLOGY: TWideStringField;
    cdsRecordIDsLitholSAMPLENO: TWideStringField;
    cdsRecordIDsLitholSMPLITH: TWideStringField;
    qNew: TSQLQuery;
    ...
    cdsDepositSamplesMissingLocationsSAMPLENO: TWideStringField;
    ...
    cdsDupSAMPLENO: TWideStringField;
    cdsDupFRAC: TWideStringField;
    cdsDupRAGE: TFloatField;
    cdsDupRAGEPERROR: TFloatField;
    cdsDupMATERIALABR: TWideStringField;
    cdsDupPREFLEVEL: TSmallintField;
    cdsRecordIDsDupRECORDID: TIntegerField;
    cdsRecordIDsDupINTERPABR: TWideStringField;
    cdsRecordIDsDupRAGE: TFloatField;
    cdsRecordIDsDupRAGEPERROR: TFloatField;
    cdsRecordIDsDupMATERIALABR: TWideStringField;
    cdsRecordIDsDupSAMPLENO: TWideStringField;
    cdsRecordIDsDupPREFLEVEL: TSmallintField;
    cdsRecordIDsDupqDup: TDataSetField;
    cdsRecordIDsDupISOTOPESYSTEM: TWideStringField;
    cdsDupISOSYSTEM: TWideStringField;
    QdmSmpORIGINALNO: TWideStringField;
    QdmSmpLITHCLASSID: TWideStringField;
    cdsQdmSmpORIGINALNO: TWideStringField;
    cdsQdmSmpLITHCLASSID: TWideStringField;
    ...
    cdsGDUsGDUNAME: TWideStringField;
    cdsGDUsRCNMDLID: TWideStringField;
    ...
    cdsGDUPDFCURVEINTERP: TWideStringField;
    ...
    cdsGDURecordAgesRCNMDLID: TWideStringField;
    ...
    cdsGDURecordAgesINTERPABR: TWideStringField;
    ...
    cdsMaxAgeRefSOURCESHORT: TWideStringField;
    cdsGDUsMAXAGEREFS: TWideStringField;
    qGDUSmpdataAges: TSQLQuery;
    dspGDUSmpdataAges: TDataSetProvider;
    cdsGDUSmpdataAges: TClientDataSet;
    dsGDUSmpdataAges: TDataSource;
    cdsGDUsLIMYNGP: TFloatField;
    cdsGDUPDFSTEPS: TIntegerField;
    cdsGDUPDFCUMULATIVEVALUE: TFloatField;
    cdsGDUsMAXDETRITALCRSRS: TFloatField;
    cdsGDUsMAXLIPAGE: TFloatField;
    cdsGDUsCOUNTIGNEOUS: TFMTBCDField;
    cdsGDUsCOUNTMETAMORPHIC: TFMTBCDField;
    cdsGDUsCOUNTCRSRS: TFMTBCDField;
    cdsGDUsCOUNTDETRITAL: TFMTBCDField;
    cdsGDUsCOUNTDETRITALCRSRS: TFMTBCDField;
    cdsGDUsCOUNTLIPS: TFMTBCDField;
    cdsGDUsDATEUPDATED: TSQLTimeStampField;
    cdsGDUsLIMOLDPREV: TFloatField;
    cdsGDUsLIMYNGPREV: TFloatField;
    cdsGDUsMAXIGNZR2DM: TFloatField;
    cdsGDUsCOUNTIGNZR2DM: TFMTBCDField;
    qGDULIPages: TSQLQuery;
    dspGDULIPages: TDataSetProvider;
    cdsGDULIPages: TClientDataSet;
    dsGDULIPages: TDataSource;
    cdsGDUSmpdataAgesGDUID: TFMTBCDField;
    cdsGDUSmpdataAgesAGE: TFloatField;
    cdsGDUSmpdataAgesAGEERROR: TFloatField;
    cdsGDULIPagesRECORDID: TIntegerField;
    cdsGDULIPagesSAMPLENO: TWideStringField;
    cdsGDULIPagesGDUID: TFMTBCDField;
    cdsGDULIPagesAGE: TFloatField;
    cdsGDULIPagesAGEERROR: TFloatField;
    qGDUSmpdataT1T2Ages: TSQLQuery;
    dspGDUSmpdataT1T2Ages: TDataSetProvider;
    cdsGDUSmpdataT1T2Ages: TClientDataSet;
  ...
  public
    ...
    procedure CalculateGDUPDFS(tRcnMdlID : string; tSteps : integer;
    ...
    procedure FindMaxAgeReference(iGDUID : integer; tRcnMdlID : string;
                              ...
                              var WasSuccessful : boolean);
    procedure CalculateGDUMinAge(tRcnMdlID : string;  tSteps : integer;
                                  iGDUID : integer; iCurveOrder : integer;
                                  CurveInterpID : string;
                                  AndOr : string;
                              var CountRecords : integer;
...
begin
  ...
  result:=SystemTimeToDateTime(GMTST);
end;
...
procedure TdmDVC.CalculateGDUPDFS(tRcnMdlID : string;  tSteps : integer;
                                  iGDUID : integer; iCurveOrder : integer;
                                  CurveInterpID : string;
                                  AndOr : string;
                              var CountRecords : integer;
...
begin
  ...
  dmDVC.qDelete.ParamByName('STEPS').AsInteger := tSteps;
  dmDVC.qDelete.ParamByName('GDUID').AsInteger := iGDUID;
  //ShowMessage(IntToStr(iCurveOrder));
  ...
  begin
    ...
    dmDVC.qGDURecordAges.ParamByName('USERID').AsString := 'BRUCEEGLINGTON';
    if (iCurveOrder = 8) then
    begin
      dmDVC.qGDURecordAges.ParamByName('CLOSURETASSOC').AsString := 'Intermediate';
      //dmUser.SetDeveloperData('CurveOrder=8');
      //dmUser.SetDeveloperData('GDUID='+IntToStr(iGDUID));
      //dmUser.SetDeveloperData(dmDVC.qGDURecordAges.SQL.Text);
    end;
    if (iCurveOrder = 9) then
    begin
      dmDVC.qGDURecordAges.ParamByName('CLOSURETASSOC').AsString := 'Low';
    end;
    if (iCurveOrder = 10) then
    begin
      dmDVC.qGDURecordAges.ParamByName('CLOSURETASSOC').AsString := 'Very Low';
    end;
  ...
  begin
    ...
    dmStrat.qGDUDEPOSITAGES.ParamByName('RCNMDLID').AsString := tRcnMdlID;
    dmStrat.qGDUDEPOSITAGES.ParamByName('GDUID').AsInteger := iGDUID;
    dmStrat.qGDUDEPOSITAGES.ParamByName('USERID').AsString := 'BRUCEEGLINGTON';
    dmStrat.cdsGDUDEPOSITAGES.Open;
    //ShowMessage('4'+tRcnMdlID);
    //set query to select records for specified GDU and reconstruction model
    //from StratDB for deposit records
    dmStrat.cdsGDUDEPOSITAGES.First;
  end;
  j := 0;
  CountRecords := 0;
  tempmax := 0.0;
  ...
  begin
    ...
    begin
      ...
      //ShowMessage('check grid contents');
      if (dmDVC.cdsGDUSmpdataAges.RecordCount > 0) then
      begin
        ...
        repeat
          try
            ...
            try
              ...
              //if (j < 5) then ShowMessage(IntToStr(j)+'  '+FormatFloat('###0.000',tx));
              ...
              ShowMessage('Problem at j = '+IntToStr(j));
            end;
          finally
    ...
    begin
      ...
      try
        ...
        begin
          //ShowMessage('6e');
          dmDVC.cdsGDULIPAges.DisableControls;
          repeat
            try
              j := j + 1;
              //ShowMessage('j = '+IntToStr(j));
              try
                tx := dmDVC.cdsGDULIPagesAGE.AsFloat;
                if ((tx > 0.0) and (tx < 5000.0) and (tx > MaxAge)) then MaxAge := tx;
                txp := dmDVC.cdsGDULIPagesAGEERROR.AsFloat;
                txm := dmDVC.cdsGDULIPagesAGEERROR.AsFloat;
                tx1 := (txp+txm)/2.0;   //need to make this equally distributed about the age
                tx1 := tx1;   //convert to 1 sigma from original 95% confidence
                if (tx1 < MinimumUncertainty) then tx1 := MinimumUncertainty;
                if ((tx > 0.0) and (tx1 > 0.0)) then
              ...
              dmDVC.cdsGDULIPages.Next;
            end;
          until dmDVC.cdsGDULIPages.EOF;
          dmDVC.cdsGDULIPAges.EnableControls;
        end;
      except
      end;
    end;
    ...
    begin
      //ShowMessage('104');
      if (dmStrat.cdsGDUDepositAges.RecordCount > 0) then
      begin
        dmStrat.cdsGDUDepositAges.DisableControls;
        repeat
          try
            j := j + 1;
            tx := dmStrat.cdsGDUDepositAgesAPPROXAGE.AsFloat;
            if ((tx > 0.0) and (tx < 5000.0) and (tx > MaxAge)) then MaxAge := tx;
            txp := dmStrat.cdsGDUDepositAgesAPPROXAGEUNCERTAINTY.AsFloat;
            txm := dmStrat.cdsGDUDepositAgesAPPROXAGEUNCERTAINTY.AsFloat;
            tx1 := (txp+txm)/2.0;   //need to make this equally distributed about the age
            tx1 := tx1/1.96;   //convert to 1 sigma from original 95% confidence
            if (tx1 < MinimumUncertainty) then tx1 := MinimumUncertainty;
            if ((tx > 0.0) and (tx1 > 0.0)) then
            ...
            dmStrat.cdsGDUDepositAges.Next;
          end;
        until dmStrat.cdsGDUDepositAges.EOF;
        dmStrat.cdsGDUDepositAges.EnableControls;
      end
    end;
    //ShowMessage('7');
    CountRecords := j;
    ...
    for k := 0 to Steps do
    begin
      tSum := tSum + Spectrum2d[k,1]*tempmax;
    end;
    ...
    try
      ...
      begin
        ...
        begin
          ...
          dmDVC.qNew.ParamByName('STEPS').AsInteger := tSteps;
          ...
          dmDVC.qNew.ParamByName('CUMULATIVEVALUE').AsFloat := tCumulative;
...
procedure TdmDVC.CalculateGDUMinAge(tRcnMdlID : string;  tSteps : integer;
                                  iGDUID : integer; iCurveOrder : integer;
                                  CurveInterpID : string;
                                  AndOr : string;
                              var CountRecords : integer;
...
begin
      ...
      begin
        ...
        repeat
          try
            j := j + 1;
            tx := dmDVC.cdsGDURecordAgesRAGE.AsFloat;
            if ((tx > 0.0) and (tx < 5000.0) and (tx < MinAge)) then MinAge := tx;
          finally
            dmDVC.cdsGDURecordAges.Next;
          end;
        until dmDVC.cdsGDURecordAges.EOF;
  ...
  begin
    try
      ...
      dmDVC.qUpdate.ParamByName('GDUID').AsInteger := iGDUID;
      dmDVC.qUpdate.ParamByName('COUNTRECORDS').AsInteger := CountRecords;
      dmDVC.qUpdate.ParamByName('MINAGE').AsFloat := MinAge;
      dmDVC.qUpdate.ParamByName('DATEUPDATED').AsDateTime := Now;
      TD := dmDVC.sqlcDateView.BeginTransaction(TDBXIsolations.ReadCommitted);
      try
        dmDVC.qUpdate.ExecSQL(false);
